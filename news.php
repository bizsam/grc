...
<body>
    ...
    <section class="container my-5 main-section">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
            <?php
            $news = [
                ['title' => 'New Classifieds Feature Launched', 'content' => 'Learn about our latest updates for better ad management.', 'image' => 'https://via.placeholder.com/300x200'],
                ['title' => 'Top Selling Items This Month', 'content' => 'Discover what’s trending in our marketplace.', 'image' => 'https://via.placeholder.com/300x200'],
                ['title' => 'Tips for Safe Online Transactions', 'content' => 'Stay secure while buying and selling online.', 'image' => 'https://via.placeholder.com/300x200']
            ];
            foreach ($news as $item) {
                ...
                echo '<p class="card-text">' . htmlspecialchars($item['content']) . '</p>';
                echo '<a href="#" class="btn btn-success">Read More</a>';
                echo '</div></div></div>';
            }
            ?>
        </div>
