...
<body>
    ...
    <section class="container my-5 main-section">
        <h1 class="text-center mb-4">Our Pages</h1>
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
            <?php
            $pages = [
                ['title' => 'About Us', 'content' => 'Learn more about our classifieds platform and mission.'],
                ['title' => 'Terms & Conditions', 'content' => 'Review our terms for using the platform.'],
                ['title' => 'Privacy Policy', 'content' => 'Understand how we handle your data.']
            ];
            foreach ($pages as $page) {
                echo '<div class="col">';
                echo '<div class="card h-100">';
                echo '<div class="card-body">';
                echo '<h5 class="card-title">' . htmlspecialchars($page['title']) . '</h5>';
                echo '<p class="card-text">' . htmlspecialchars($page['content']) . '</p>';
                echo '<a href="#" class="btn btn-success">View Page</a>';
                echo '</div></div></div>';
            }
            ?>
        </div>
