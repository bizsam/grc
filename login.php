...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!Auth::checkRateLimit('login', 0)) { // Rate limit for login attempts
        ...
        try {
            if (Auth::login($email, $password)) {
                ...
                Auth::incrementRateLimit('login', 0); // Increment for failed attempt
...
<body>
    ...
    <section class="container my-5 main-section">
        ...
        <div class="card p-4">
            ...
            <div class="mt-3">
                <p>Or login with:</p>
                <a href="?action=google" class="social-btn google-btn">Login with Google</a>
                <a href="?action=facebook" class="social-btn facebook-btn">Login with Facebook</a>
            </div>
